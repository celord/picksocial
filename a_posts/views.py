...
def comment_sent(request, pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            comment.save()
    context = {"comment": comment, "reply_form": reply_form, "post": post}
...
def reply_sent(request, pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            reply.save()
    context = {"comment": comment, "reply_form": reply_form, "reply": reply}
...
def like_comment(request, comment):
    return render(request, "snippets/likes_comments.html", {"comment": comment})
